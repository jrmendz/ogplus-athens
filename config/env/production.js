const ICHIPS_URL = "https://ichips.oriental-game.com";
module.exports = {
  ...
  **************************************************************************/
  ...
  session: {
    ...
    url: 'redis://root:'+process.env.REDIS_PASSWORD+'@'+process.env.REDIS_HOST+':'+process.env.REDIS_PORT+'/19',
    cookie: {
      secure: true,
  ...
  services: {
    ...
    gameapp: "wss://aquarius.oriental-game.com:12345/df525c4b6d094937cb020ba1644d9224",
    gameAppServerKey: "df525c4b6d094937cb020ba1644d9224",
    chat: {
      validator: "https://ogplus.oriental-game.com:8050/v1/domain"
    }
  },
  game_env: "ogplus",
  game_config: {
