...
#####To create new api documentations
 1. Execute `cd ./projects`
 2. Next, execute command `swagger project create [name-of-project]`
 3. Wait for the installation to finish.

#####To edit created api documentations
  1. Execute `cd ./projects/[name-of-project]`
  2. Next, execute command `swagger project edit`
  3. It will automatically open your browser.
